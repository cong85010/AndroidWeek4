...
public class ProductAdapterNew extends BaseAdapter {
    ...
    public ProductAdapterNew(Context context, int idLayout, List<ProductNew> listProduct) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        TextView tvTitle = (TextView) convertView.findViewById(R.id.idTitle);
        TextView tvPrice = (TextView) convertView.findViewById(R.id.idPrice);
        TextView tvPercent = (TextView) convertView.findViewById(R.id.idPercent);
        ...
        final ProductNew product = listProduct.get(position);

        if (listProduct != null && !listProduct.isEmpty()) {
            tvTitle.setText(product.getTitle());
            tvPrice.setText(product.getPrice()+"");
            tvPercent.setText(product.getPercent()+"%");
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(context, product.getTitle(), Toast.LENGTH_LONG).show();
